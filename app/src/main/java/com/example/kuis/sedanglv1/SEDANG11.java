...
public class SEDANG11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sedang11);
    ...
    public void tampildialog() {
        ...
        builder.setPositiveButton("Lanjutkan", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent jancuk = new Intent(SEDANG11.this, halaman2.class);
                startActivity(jancuk);
                Toast.makeText(SEDANG11.this, "Lanjutkan",Toast.LENGTH_SHORT).show();
