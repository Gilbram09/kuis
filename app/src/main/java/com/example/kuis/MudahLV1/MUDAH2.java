...
public class MUDAH2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mudah2);
    ...
    public void tampildialog() {
        ...
        builder.setPositiveButton("Lanjutkan", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent jancuk = new Intent(MUDAH2.this, MUDAH3.class);
                startActivity(jancuk);
                Toast.makeText(MUDAH2.this, "Lanjutkan",Toast.LENGTH_SHORT).show();
